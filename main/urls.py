...
from .views import MainPageView, CourseDetailView, RecordAttendanceView, StudentsListView, StudentUpdateView,  TeachersListView, TeacherUpdateView, CoursesListView, CourseUpdateView
